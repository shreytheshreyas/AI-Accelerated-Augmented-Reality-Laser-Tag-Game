...
## Acknowledgments
- This ambitious project was brought to life through the exceptional contributions of each team member. Bryan's(@Bryanbeh1998) deep expertise in sensors, operating systems, and real-time embedded systems formed the foundation of our hardware implementation. Shixi's(@fansxx) comprehensive knowledge of artificial intelligence, UI development, GPU programming, and digital hardware design enabled sophisticated motion detection and processing capabilities. Shreyas'(@shreytheshreyas) mastery of network protocol design, parallel computing, data engineering, and machine learning was instrumental in creating robust communication systems. Dorian's(@dorianfong98) creative vision in User Interaction Design and game development resulted in an engaging and intuitive player experience. The project's success was orchestrated by our team leader, KJ (@kaijiel24), whose background in network infrastructure management, cybersecurity, and distributed systems provided the strategic direction and technical leadership needed to unite these diverse elements into a cohesive system.
- We extend our deepest gratitude to our project supervisor, Vishruti Rajan(@sevenseasofbri), whose extensive expertise in real-time embedded systems, robotics, and computer hardware architecture proved invaluable throughout this journey. Her unwavering dedication went far beyond traditional supervision – from conducting dedicated consultation sessions to providing crucial guidance during late-night troubleshooting discussions. Her mentorship was instrumental not only in addressing technical challenges but also in helping us navigate the most demanding phases of the project. Her commitment to our success and willingness to provide support whenever needed exemplified exceptional mentorship and significantly contributed to the project's successful completion.
- Finally, we extend our profound appreciation to our project mentors, Professor Sangit Sasidhar and Professor Jithin Vachery. Their expert guidance, insightful feedback, and steadfast mentorship throughout this project were fundamental to our success. Their vision and expertise helped shape this system into something far beyond our initial expectations, and for this, we are immensely grateful. Their influence on both our project and our growth as engineers will continue to resonate well beyond the scope of this work.

...
## Acknowledgments
- This ambitious project was brought to life through the exceptional contributions of each team member. Bryan's deep expertise in sensors, operating systems, and real-time embedded systems formed the foundation of our hardware implementation. Shixi's comprehensive knowledge of artificial intelligence, UI development, GPU programming, and digital hardware design enabled sophisticated motion detection and processing capabilities. Shreyas' mastery of network protocol design, parallel computing, data engineering, and machine learning was instrumental in creating robust communication systems. Dorian's creative vision in User Interaction Design and game development resulted in an engaging and intuitive player experience. The project's success was orchestrated by our team leader, KJ (Kaijie), whose background in network infrastructure management, cybersecurity, and distributed systems provided the strategic direction and technical leadership needed to unite these diverse elements into a cohesive system.
- We extend our deepest gratitude to our project supervisor, Vishruti Rajan, whose extensive expertise in real-time embedded systems, robotics, and computer hardware architecture proved invaluable throughout this journey. Her unwavering dedication went far beyond traditional supervision – from conducting dedicated consultation sessions to providing crucial guidance during late-night troubleshooting discussions. Her mentorship was instrumental not only in addressing technical challenges but also in helping us navigate the most demanding phases of the project. Her commitment to our success and willingness to provide support whenever needed exemplified exceptional mentorship and significantly contributed to the project's successful completion.

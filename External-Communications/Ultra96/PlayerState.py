...
class PlayerStateBase:
    ...
    def get_difference(self, game_state_received):
        ...
        self._get_difference_helper(
            diff_dict, self.bullets, game_state_received.bullets, "bullets"
        )
        self._get_difference_helper(
            diff_dict, self.grenades, game_state_received.grenades, "grenades"
        )
        self._get_difference_helper(
            diff_dict, self.shield_time, game_state_received.shield_time, "shield_time"
        )
        self._get_difference_helper(
            diff_dict,
            self.shield_health,
            game_state_received.shield_health,
            "shield_health",
        )
        self._get_difference_helper(
            diff_dict, self.num_shield, game_state_received.num_shield, "num_shield"
        )
        self._get_difference_helper(
            diff_dict, self.num_deaths, game_state_received.num_deaths, "num_deaths"
        )
